...
def resolve(req: ArtifactRequest):
    ...
    return ArtifactResponse(
        ...
        conflict_entities=result.extracted_entities,   # FIX: state field is extracted_entities
...
if __name__ == "__main__":
    port = int(os.environ.get("PORT", 8000))   # FIX: Railway injects PORT env var at runtime
